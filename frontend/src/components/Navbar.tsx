...
type IconName = "home" | "compass" | "trophy" | "edit" | "shield" | "discord" | "users" | "user" | "bell" | "book";
...
function NavIcon({ name }: { name: IconName }) {
  ...
  return (
    <svg viewBox="0 0 24 24" className="h-[18px] w-[18px]" aria-hidden="true">
      ...
      {name === "book" && <><path {...common} d="M5 4.5h5a2 2 0 0 1 2 2v13a2 2 0 0 0-2-2H5z" /><path {...common} d="M19 4.5h-5a2 2 0 0 0-2 2v13a2 2 0 0 1 2-2h5z" /></>}
    </svg>
  );
}
  ...
  return (
    <>
      ...
      >
        ...
        <SidebarLink to="/regulamentos" label="Regulamento" icon="book" />
